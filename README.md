...
3. The command /go is followed by the name of the location you want to arrive. A path is plotted in a map. (Eg: /go Campus Nord)
4. There is available the command /help for a brief description of usage and functionality of each module.
## Support
